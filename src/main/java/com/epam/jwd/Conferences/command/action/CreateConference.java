...
//    public static final String ADMIN_CONSTANT = "ADMIN";
    ...
    public CommandResponse execute(CommandRequest request) {
        final String confTitle = request.getParameter(ApplicationConstants.CONFERENCE_TITLE_PARAMETER_NAME);
        ...
        if (creatorRole == null || !creatorRole.equals(ApplicationConstants.ADMIN_CONSTANT)) {
            return prepareErrorPage(request, ApplicationConstants.NO_PERMISSION_TO_CREATE_CONFERENCE_MSG);
        ...
        } else if (!validator.isLengthValid(confTitle, ApplicationConstants.MAX_LENGTH_OF_CONFERENCE_TITLE_IN_DB)) {
        ...
        if (managerId == null) {
            return prepareErrorPage(request, ApplicationConstants.INVALID_MANAGER_THERE_IS_NO_SUCH_MANAGER_IN_SYSTEM_MSG);
        }
        ...
        try {
            ...
            request.setAttribute(ApplicationConstants.CONFERENCES_ATTRIBUTE_NAME, updatedConferences);
            ...
            return ApplicationConstants.CONFERENCE_CREATION_SUCCESS_RESPONSE;
        } catch (DuplicateException e) {
            logger.info(ApplicationConstants.DUPLICATE_CONFERENCE_MESSAGE);
            return prepareErrorPage(request, ApplicationConstants.DUPLICATE_CONFERENCE_MESSAGE);
        }
    }
    ...
    private CommandResponse prepareErrorPage(CommandRequest request, String errorMessage) {
        ...
        return ApplicationConstants.CREATE_NEW_CONFERENCE_ERROR_RESPONSE;
    }
    ...
    private CommandResponse prepareErrorPageBackToMainPage(CommandRequest request,
        ...
        request.setAttribute(ApplicationConstants.ERROR_ATTRIBUTE_NAME, errorMessage);
        return ApplicationConstants.CREATE_CONFERENCE_ERROR_RESPONSE_TO_MAIN_PAGE;
    }
}
