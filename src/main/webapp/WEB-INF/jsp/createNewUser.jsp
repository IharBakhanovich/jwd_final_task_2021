...
<div class="outer">
    ...
    <c:choose>
        ...
        <c:otherwise>
            <form action="${pageContext.request.contextPath}/controller?command=create_new_user&creatorId=${sessionScope.userId}&creatorRole=${sessionScope.userRole}"
                  method="post">
                ...
                <c:choose>
                    <c:when test="${sessionScope.userRole eq Role.ADMIN}">
                        <input type="submit" value=
                            <fmt:message key="label.submitNewUserCreationButton"/> class="button">
                    </c:when>
                    <c:otherwise>
                        <input type="submit" value=
                            <fmt:message key="label.registerButton"/> class="button">
                    </c:otherwise>
                </c:choose>
            </form>
        </c:otherwise>
