...
<div class="outer">
    <c:choose>
        ...
        <c:otherwise>
            <h3><fmt:message key="label.toCreateNewSectionPart1"/> ' ${requestScope.conferenceTitle} ' <fmt:message
                    key="label.toCreateNewSectionPart2"/></h3>
        </c:otherwise>
    </c:choose>
        ...
        <c:otherwise>
            <form action="${pageContext.request.contextPath}/controller?command=create_new_section&creatorId=${sessionScope.userId}&creatorRole=${sessionScope.userRole}&conferenceTitle=${requestScope.conferenceTitle}"
                ...
                <input type="submit" value=
                    <fmt:message key="label.submitSectionCreationButton"/> class="button">
                    <%--                            <c:choose>--%>
